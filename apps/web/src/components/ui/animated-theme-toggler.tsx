/**
 * Vendorizado do MagicUI (magicui.design/docs/components/animated-theme-toggler).
 * Usado em modo controlado: ele faz a transicao com a View Transitions API e
 * quem guarda a escolha e `hooks/theme/use-theme.ts`.
 */
"use client"
